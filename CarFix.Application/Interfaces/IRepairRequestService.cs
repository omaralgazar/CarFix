...
namespace CarFix.Application.Interfaces
{
    ...
    {
        Task<RepairRequestResponseDto> CreateRequestAsync(
            Guid customerUserId,
            CreateRepairRequestDto dto);

        Task<List<RepairRequestResponseDto>> GetRepairRequestsByCustomerAsync(
            Guid customerId);
        Task CancelRequestAsync(Guid customerUserId, Guid requestId);
        Task<RepairRequestResponseDto> GetRequestByIdAsync(
            Guid customerUserId,
            Guid requestId);
    }
}
